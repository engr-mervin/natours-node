...
${frame.code}`;
    ...
    '4uyBp': [
      function (require, module, exports) {
        ...
        var _errorTitle_dataset,
          _document_getElementById,
          _document,
          _document1;
        const errorTitle = document.querySelector('.error__title');
        const statusCode = Number(
          errorTitle === null || errorTitle === void 0
            ? void 0
            : (_errorTitle_dataset = errorTitle.dataset) === null ||
              _errorTitle_dataset === void 0
            ? void 0
            : _errorTitle_dataset.status
        );
        const loginForm = document.querySelector('.form--login');
        const locationsString =
          ((_document = document) === null || _document === void 0
            ? void 0
            : (_document_getElementById = _document.getElementById('map')) ===
                null || _document_getElementById === void 0
            ? void 0
            : _document_getElementById.dataset.locations) || '';
        const locations = locationsString ? JSON.parse(locationsString) : null;
        const bookTour =
          (_document1 = document) === null || _document1 === void 0
            ? void 0
            : _document1.getElementById('book-tour');
        if (bookTour) {
          const id = bookTour.dataset.tourId;
          bookTour.addEventListener('click', (e) => {
            e.preventDefault();
            (0, _alertsJs.errorCatcher)((0, _stripeJs.proceedToCheckout), id);
          });
        }
        if (loginForm) {
        ...
        if (updateUserDataForm) {
          ...
          updateUserDataForm.addEventListener('submit', (event) => {
            ...
            if (
              (photo === null || photo === void 0 ? void 0 : photo.files) &&
              photo.files[0]
            )
        ...
        if (updatePasswordForm) {
          ...
          updatePasswordForm.addEventListener('submit', async (event) => {
            event.preventDefault();
            await (0, _alertsJs.errorCatcher)(
              (0, _updateInfoJs.updatePassword),
              {
                currentPassword:
                  (currentPassword === null || currentPassword === void 0
                    ? void 0
                ...
                password:
                  (password === null || password === void 0
                    ...
                    : password.value) || '',
                passwordConfirm:
                  (passwordConfirm === null || passwordConfirm === void 0
                    ? void 0
    ...
    qZEOz: [
      ...
      {
        './alerts.js': 'j4hQk',
        '@parcel/transformer-js/src/esmodule-helpers.js': '5Birt',
      },
    ],
    j4hQk: [
      function (require, module, exports) {
        ...
        const hideAlert = function () {
          ...
          if (alertElement)
            (_alertElement_parentElement = alertElement.parentElement) ===
              null || _alertElement_parentElement === void 0
              ? void 0
              : _alertElement_parentElement.removeChild(alertElement);
        };
        const showAlert = function (type, message) {
          ...
          (_document_querySelector = document.querySelector('body')) === null ||
          _document_querySelector === void 0
            ? void 0
            : _document_querySelector.insertAdjacentHTML('afterbegin', markup);
    ...
    hu9K2: [
      function (require, module, exports) {
        ...
        const proceedToCheckout = async function (id) {
